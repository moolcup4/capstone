        ...
        function go_url(){
            <?php
                ...
                while($row = mysqli_fetch_array($result)){
             	...
             	if($count>=3){
             		echo 'location.href="./checkface.php"';	
             	}	

                #만약 customer table에 값이 있으면(얼굴 인식을 하면)
        ...
        <div id="banner" class="container">
            <section>
               ...
               <!--  <a onclick="show('ice');" class="button xlarge">Iced</a>　
                ...
                <br><br><br>
                <a class="button xlarge" href="./order.php"> <br><br><br>장바구니<br><br><br></a>
            </section>
        </div>
        <!-- Extra -->
        <div id="extra">
        ...
        <script>
            ...
            function test(name,price) {
                ...
                myWindow = window.open(
                    "popup.php", '_blank', "toolbar=no, left="+popupX+",top=200, scrollbars=yes, width=1400,height=2000"
                );
